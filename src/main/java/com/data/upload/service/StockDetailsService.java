...
public class StockDetailsService {
	...
	public void uploadFile(MultipartFile file) throws Exception {
		...
		records.forEach(record -> {
			...
			try {
				...
				stock.setPercent_return_next_dividend(
						Double.parseDouble(replaceNull(record.getString("percent_return_next_dividend"))));
	...
	public List<StockDetails> getQuaterlyStock(int number, String stock) throws Exception {
